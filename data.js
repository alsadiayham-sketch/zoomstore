const DEFAULT_PRODUCTS = [
    ...
    { id: 5, name: 'شنطة Coach Tabby', brand: 'Coach', category: 'حقائب', sizes: [{ size: 'S', unit: 'size', price: 200 }, { size: 'M', unit: 'size', price: 260 }], discount: 5, image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop', status: 'normal' },
    { id: 6, name: 'شنطة Calvin Klein مسطحة', brand: 'Calvin Klein', category: 'حقائب', sizes: [{ size: 'One Size', unit: 'size', price: 160 }], discount: 0, image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&h=400&fit=crop', status: 'normal' },
    { id: 7, name: 'شنطة Guess Evening Clutch', brand: 'Guess', category: 'حقائب', sizes: [{ size: 'One Size', unit: 'size', price: 120 }], discount: 15, image: 'https://images.unsplash.com/photo-1584917865442-de89df76afd3?w=400&h=400&fit=crop', status: 'special' },
    { id: 8, name: 'شنطة Dior Saddle', brand: 'Dior', category: 'حقائب', sizes: [{ size: 'M', unit: 'size', price: 320 }, { size: 'L', unit: 'size', price: 380 }], discount: 0, image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=400&h=400&fit=crop', status: 'normal' },
    { id: 9, name: 'اسوارة ستانلس ستيل ذهبي', brand: 'Zoom', category: 'اساور', sizes: [{ size: '17', unit: 'cm', price: 45 }, { size: '19', unit: 'cm', price: 50 }], discount: 0, image: 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=400&h=400&fit=crop', status: 'bestseller' },
    { id: 10, name: 'اسوارة ستانلس فضي مع حجر', brand: 'Zoom', category: 'اساور', sizes: [{ size: '17', unit: 'cm', price: 55 }, { size: '19', unit: 'cm', price: 60 }], discount: 0, image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=400&h=400&fit=crop', status: 'special' },
    { id: 11, name: 'طقم اساور ستانلس 3 قطع', brand: 'Zoom', category: 'اساور', sizes: [{ size: 'One Size', unit: 'size', price: 80 }], discount: 10, image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400&h=400&fit=crop', status: 'bestseller' },
    { id: 12, name: 'اسوارة Pandora ستايل', brand: 'Pandora', category: 'اساور', sizes: [{ size: '17', unit: 'cm', price: 65 }, { size: '19', unit: 'cm', price: 70 }], discount: 0, image: 'https://images.unsplash.com/photo-1573408301185-9146fe634ad0?w=400&h=400&fit=crop', status: 'normal' },
    { id: 13, name: 'اسوارة Calvin Klein رفيعة', brand: 'Calvin Klein', category: 'اساور', sizes: [{ size: '16', unit: 'cm', price: 75 }, { size: '18', unit: 'cm', price: 80 }], discount: 0, image: 'https://images.unsplash.com/photo-1611591437281-460bfbe1220a?w=400&h=400&fit=crop', status: 'normal' },
    { id: 14, name: 'اسوارة Michael Kors ذهبية', brand: 'Michael Kors', category: 'اساور', sizes: [{ size: '17', unit: 'cm', price: 90 }, { size: '19', unit: 'cm', price: 95 }], discount: 5, image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400&h=400&fit=crop', status: 'special' },
    { id: 15, name: 'سلسال Dior قلب', brand: 'Dior', category: 'اكسسوارات', sizes: [{ size: '45', unit: 'cm', price: 85 }], discount: 0, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400&h=400&fit=crop', status: 'bestseller' },
    { id: 16, name: 'خاتم Pandora فضي', brand: 'Pandora', category: 'اكسسوارات', sizes: [{ size: '6', unit: 'ring', price: 50 }, { size: '7', unit: 'ring', price: 50 }, { size: '8', unit: 'ring', price: 50 }], discount: 0, image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&h=400&fit=crop', status: 'normal' },
    { id: 17, name: 'حلق Guess Crystal', brand: 'Guess', category: 'اكسسوارات', sizes: [{ size: 'One Size', unit: 'size', price: 40 }], discount: 0, image: 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=400&h=400&fit=crop', status: 'normal' },
    { id: 18, name: 'عقد Calvin Klein طبقات', brand: 'Calvin Klein', category: 'اكسسوارات', sizes: [{ size: '42', unit: 'cm', price: 70 }, { size: '48', unit: 'cm', price: 80 }], discount: 0, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400&h=400&fit=crop', status: 'normal' },
    { id: 19, name: 'طقم اكسسوارات Coach', brand: 'Coach', category: 'اكسسوارات', sizes: [{ size: 'One Size', unit: 'size', price: 120 }], discount: 12, image: 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=400&h=400&fit=crop', status: 'special' },
    { id: 20, name: 'سلسال Michael Kors مع بندول', brand: 'Michael Kors', category: 'اكسسوارات', sizes: [{ size: '50', unit: 'cm', price: 95 }], discount: 0, image: 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=400&h=400&fit=crop', status: 'normal' }
];
